...
import sys
from scene import Scene, GaussianModel,SceneFromGaussians
...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from, first_stage_step, second_stage_step, remove_noise, hdr_rotation, reg_hdr_weight=0.001, reg_material_weight=0.1):
    ...
    # scene = SceneFromGaussians(dataset, gaussians)
    ...
    elif dataset.from_gaus:
        gaussians = GaussianModel(dataset.sh_degree)
        ply_path="/home/chengwr/code/Relightable3DGaussian/FA_scene/gs_results/chair.ply"
        gaussians.load_ply_safe(ply_path)
        base_dir="../Relightable3DGaussian/FA_scene/gs_results/chair"
    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        gt_mask=viewpoint_cam.image_mask.cuda()     
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[5_000, 10_000, 15_000, 20_000, 30_000, 40_000, 50_000, 60_000])
    ...
    parser.add_argument("--first_stage_step", type=int, default = 3_000)
