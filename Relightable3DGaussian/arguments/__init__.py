...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.env_lr = 0.05
        self.env_rest_lr = 0.005

        self.base_color_lr = 0.2
        self.roughness_lr = 0.01
        self.light_lr = 0.001
        self.light_rest_lr = 0.0005
        self.light_init = 3.0
        ...
        self.densify_grad_normal_threshold = 1e-5
        self.normal_densify_from_iter = 0

        self.lambda_depth = 0.0
        self.lambda_depth_smooth = 0.0
        self.lambda_mask_entropy = 0.02
